...
const routes: RouteRecordRaw[] = [
  {
    ...
    meta: {
      ...
      keepAlive: true,
      order: 1000,
      title: $t('cron.route.systemManage'),
    },
    children: [
      {
        path: '/system/admin',
